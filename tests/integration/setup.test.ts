  ...
  const testUsers = [
    {
      ...
      password:
        "$argon2id$v=19$m=65536,t=3,p=1$test salt test salt test salt test salt$test hash test hash test hash test hash test hash test hash",
    ...
    },
    {
      ...
      password:
        "$argon2id$v=19$m=65536,t=3,p=1$another salt another salt another salt another salt$another hash another hash another hash",
    ...
    },
    {
      ...
      password:
        "$argon2id$v=19$m=65536,t=3,p=1$inactive salt inactive salt inactive salt$inactive hash inactive hash inactive hash",
...
export async function seedTestTasks(
  ...
  const testTasks = [
    ...
    },
    {
      user_id: userId,
      title: "Urgent Task",
      description: "Urgent task to test priority",
      status: "pending",
      priority: "urgent",
    },
    {
