...
/**
 * Driven adapter: Drizzle/Postgres persistence for `Item` entities.
 * Satisfies the feature's `ItemRepository` port structurally and translates
...
import { items, type NewItemRow } from "./schema.ts";
